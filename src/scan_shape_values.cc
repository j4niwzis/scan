...
export module scan.shape.values;

import std;
import scan.tre;
export import scan.compiler;
export import scan.runtime;
export import scan.shape.walk;
...
export template <class ShapeType>
...
export template <class Type, fixed_string Format, std::size_t Group, class ShapeType>
...
export template <class Type, fixed_string Format, class MarkType, class ColdType,
          class CarrierType>
